...
static const LPWCH g_cCacheFileNames[EffectPipelineTypeCount] = {
    L"normal3dPSO.cache",        L"ubershaderPSO.cache",       L"blitEffectPSO.cache", L"invertEffectPSO.cache",
    L"grayscaleEffectPSO.cache", L"edgeDetectEffectPSO.cache", L"blurEffectPSO.cache", L"warpEffectPSO.cache",
    L"pixelateEffectPSO.cache",  L"distortEffectPSO.cache",    L"waveEffectPSO.cache",
};

static const LPWCH g_cEffectNames[EffectPipelineTypeCount] = {
    L"Normal 3D", L"Generic post effect", L"Blit", L"Invert", L"Grayscale", L"Edge detect", L"Blur", L"Warp", L"Pixelate", L"Distort", L"Wave",
};
...
class PSOLibrary {
 public:
  ...
  void SetPipelineState(ID3D12Device* pDevice, ID3D12RootSignature* pRootSignature, ID3D12GraphicsCommandList* pCommandList,
