...
HelloFrameBuffering::HelloFrameBuffering(UINT width, UINT height, std::wstring name)
...
void HelloFrameBuffering::LoadPipeline() {
  CreateRootSignature();
  CreatePSO();
  CreateVertexBuffer();
...
void HelloFrameBuffering::CreateRootSignature() {
...
void HelloFrameBuffering::CreatePSO() {
  ...
  std::wstring vertexShaderPath = GetAssetFullPath(L"HelloFrameBuffering.hlsl");
  ...
  std::wstring pixelShaderPath = GetAssetFullPath(L"HelloFrameBuffering.hlsl");
...
void HelloFrameBuffering::CreateVertexBuffer() {
