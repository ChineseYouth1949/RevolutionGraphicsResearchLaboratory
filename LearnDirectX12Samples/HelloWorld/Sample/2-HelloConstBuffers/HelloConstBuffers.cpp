...
void HelloConstBuffers::CreatePSO() {
  ...
  std::wstring vertexShaderPath = GetAssetFullPath(L"HelloConstBuffers.hlsl");
  ...
  std::wstring pixelShaderPath = GetAssetFullPath(L"HelloConstBuffers.hlsl");
...
void HelloConstBuffers::CreateVertexBuffer() {
...
void HelloConstBuffers::CreateConstantBuffer() {
