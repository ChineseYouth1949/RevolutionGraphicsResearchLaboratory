...
HelloGenericPrograms::HelloGenericPrograms(UINT width, UINT height, std::wstring name)
...
void HelloGenericPrograms::OnInit() {
  LoadCoreInterface();
  LoadPipeline();
}
...
void HelloGenericPrograms::LoadPipeline() {
  CreateRootSignature();
  CreatePSO();
  CreateVertexBuffer();
...
void HelloGenericPrograms::CreateRootSignature() {
...
void HelloGenericPrograms::CreatePSO() {
  ...
  std::wstring vertexShaderPath = GetAssetFullPath(L"HelloGenericPrograms.hlsl");
  ...
  std::wstring pixelShaderPath = GetAssetFullPath(L"HelloGenericPrograms.hlsl");
...
void HelloGenericPrograms::CreateVertexBuffer() {
